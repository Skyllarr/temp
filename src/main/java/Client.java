...
public class Client {
    ...
    public void testHTTPS() {
        ...
        ClientConfigUtil.setConfigProperties(bindingProvider, null, null);  // this is where the elytron config is set
    ...
    public void testHTTP() throws MalformedURLException {
        ...
        ClientConfigUtil.setConfigProperties(bindingProvider, null, null);
